...
export default class DeleteDress extends Component {
            ...
            <div style={{display: 'flex', justifyContent: 'center',alignItems:'center'}}>
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group" style={{display: 'flex', justifyContent: 'center'}}>
                        <input type="submit" value="Delete this dress" className="btn btn-primary" />
                    </div>
                </form>
            </div>
        )
    ...
    onSubmit(e) {
        ...
        this.props.history.push('/menu/CRUD/dress');
    }
