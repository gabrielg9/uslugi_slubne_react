...
export default class DeleteAttraction extends Component {
            ...
            <div style={{display: 'flex', justifyContent: 'center',alignItems:'center'}}>
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group" style={{display: 'flex', justifyContent: 'center'}}>
                        <input type="submit" value="Delete this attraction" className="btn btn-primary" />
                    </div>
                </form>
            </div>
        )
    ...
    onSubmit(e) {
        ...
        this.props.history.push('/menu/CRUD/attraction');
    }
